...
/**
 * Static dummy data for UI prototype before API integration.
 * Backend team: Replace these lists with actual API responses (Retrofit/Ktor).
 * The structure mirrors the Aonime web data at web-aonime.vercel.app
 */
object DummyData {
